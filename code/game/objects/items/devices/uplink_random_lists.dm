...
//	items += new/datum/uplink_random_item(/datum/uplink_item/item/hardsuit_modules/laser_canon, reselect_propbability = 5)
	...
	items += new/datum/uplink_random_item(/datum/uplink_item/item/rig_modules/energy_net, reselect_propbability = 15)
	items += new/datum/uplink_random_item(/datum/uplink_item/item/rig_modules/ewar_voice, reselect_propbability = 15)
	items += new/datum/uplink_random_item(/datum/uplink_item/item/rig_modules/maneuvering_jets, reselect_propbability = 15)
	items += new/datum/uplink_random_item(/datum/uplink_item/item/rig_modules/egun, reselect_propbability = 15)
	items += new/datum/uplink_random_item(/datum/uplink_item/item/rig_modules/power_sink, reselect_propbability = 15)
	items += new/datum/uplink_random_item(/datum/uplink_item/item/rig_modules/laser_canon, reselect_propbability = 5)
