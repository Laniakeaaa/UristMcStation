/datum/map/gamma
	emergency_shuttle_docked_message = "Attention all hands: the escape lifepods are now unlocked. You have %ETD% to board the escape pods."
	emergency_shuttle_leaving_dock = "Attention all hands: the escape lifepods have been launched, arriving at rendezvous point in %ETA%."

	emergency_shuttle_called_message = "Attention all hands: emergency evacuation procedures are now in effect. Escape lifepods will unlock in %ETA%"
	...
	radiation_detected_message = "Attention all hands: Radiation storm approaching %STATION_NAME%. Please evacuate into one of the shielded maintenance tunnels."
...
/datum/map/nerva/level_x_biohazard_sound(bio_level)
	switch(bio_level)
		if(7)
